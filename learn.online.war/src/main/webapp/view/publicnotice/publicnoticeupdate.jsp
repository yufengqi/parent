...
<div class="wrapper row3">
  <div id="container" class="clear">
    <!-- ####################################################################################################### -->
	   ...
	   <s:form action = "updatepublicnotice.action" theme="simple" validate="true">
	      ...
	      <p>
		   ...
		   <p>
		       发布人:&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield label="发布人" required = "true"  name = "reportman" value = "%{#selectAllNew.reportman}"/>
		  </p>
		   <p>                        
		        发布时间:<s:textfield label="发布时间" name="reporttime" required = "true"  onClick="WdatePicker()">
	         <s:param name="value"><s:date name="%{#selectAllNew.reporttime}" format="yyyy-MM-dd"/></s:param>  
	      </s:textfield>
		  </p>
