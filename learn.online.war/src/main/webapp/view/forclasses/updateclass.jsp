...
<div class="wrapper row3">
  <div id="container" class="clear">
    <!-- ####################################################################################################### -->
	   ...
	   <s:form action = "glyupdateclass.action"  theme="simple" validate="true">
		  ...
		  课时安排:<s:textarea label="课时安排" name="classtime" value = "%{#selectclass.classtime}" cols="100" rows="8"/>
		   ...
		   <p>
		     课程图片:<s:textfield label="课程图片" name="classimage"  required = "true" value = "%{#selectclass.classimage}"/>
		  </p>
		   <p>
		      播放连接:<s:textfield label="播放连接" name="classlink"  required = "true" value = "%{#selectclass.classlink}"/>
		  </p>
