    ...
    <div id="homepage" class="clear">
      ...
      <div class="subnav">
       ...
       <p>
         ...
         <!-- currentPage为当前页 -->
         <s:else>
           <a href="allpassforuminfo.action?tag=3&page=1">第一页</a>
           <a href="allpassforuminfo.action?tag=3&page=<s:property value="%{currentPage-1}"/>">上一页</a>
         </s:else>
    
         <s:if test="%{currentPage != totalPage}">
         <a href="allpassforuminfo.action?tag=3&page=<s:property value="%{currentPage+1}"/>">下一页</a>
         <a href="allpassforuminfo.action?tag=3&page=<s:property value="totalPage"/>">最后一页</a>
            </s:if>
