  ...
  <div id="container" class="clear">
    <!-- ####################################################################################################### -->
       ...
       <s:if test="%{#session.register.getIdentity()==1}">
	     ...
	     <s:form action = "updateworkinfo.action" theme="simple"  validate="true">
	     <s:hidden name="zyid" value="%{#selectAllNew.zyid}"></s:hidden>
		  ...
		  <p>
		       学生姓名:<s:textfield label="学生姓名" name="studentname" required = "true" value = "%{#selectAllNew.studentname}"/>
		  </p>
		   <p>                         
		  ...
		  <p>
		    分&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数:<s:textfield label="分数" required = "true" name="reviewgrand" value = "%{#selectAllNew.reviewgrand}" readonly="true"/> 
		   </p>
		   <p>
		    教师姓名:<s:textfield label="教师姓名" name="teachername" required = "true" value = "%{#selectAllNew.teachername}" readonly="true"/> 
		   </p>
		  <p>
		    批改时间:<s:textfield label="批改时间" name="reviewtime" required = "true" value = "%{#selectAllNew.reviewtime}" readonly="true" onClick="WdatePicker()"/> 
		  </p>
		  </s:if>
		   <s:elseif test="%{#session.register.getIdentity()==0}">
	      <p>
		   ...
		   <p>
		       学生姓名:<s:textfield label="学生姓名" name="studentname" required = "true" value = "%{#selectAllNew.studentname}" readonly="true"/>
		  </p>
		   <p>                       
		  ...
		  <p>
		    分&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数:<s:textfield label="分数" name="reviewgrand" required = "true" value = "%{#selectAllNew.reviewgrand}" /> 
		   </p>
		   <p>
		    教师姓名:<s:textfield label="教师姓名" name="teachername" required = "true" value = "%{#selectAllNew.teachername}"/> 
		   </p>
		   <p>
		    批改时间:<s:textfield label="批改时间" name="reviewtime" required = "true" value = "%{#selectAllNew.reviewtime}" onClick="WdatePicker()"/> 
		   </p>
		  </s:elseif>
