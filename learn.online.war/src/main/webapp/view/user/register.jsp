  ...
  <div id="container" class="clear">
    <!-- ####################################################################################################### -->
       ...
       <h2 align = "center"><s:text name="register.info"></s:text></h2>
	    ...
	    <s:form  action = "Customerregister.action" validate="true" theme="simple" namespace="" name = "form2" onSubmit = "return chack();">
	      <p align = "center">
		  ...
		  <p align = "center"><s:submit value = "注册"></s:submit><s:reset value = "重置"></s:reset></p>
	  </s:form> 
	 </div>
	 </div>
