...
<div class="wrapper row3">
  <div id="container" class="clear">
    <!-- ####################################################################################################### -->
     ...
     <s:form action = "update.action" theme="simple">
	   <s:hidden name="zcid" value="%{#user.zcid}"></s:hidden>
	   <p>
	   用户名&nbsp;&nbsp;&nbsp;&nbsp;:<s:textfield name = "yhm" label = "用户名" value = "%{#user.yhm}"></s:textfield>
	   </p>
	   <p>
	    真实姓名:<s:textfield name = "registername"  label = "真实姓名" value = "%{#user.registername}"></s:textfield>
	   </p>
	   <p>
	    登录密码:<s:password name = "dlpassword" label = "登录密码" value = "%{#user.dlpassword}"></s:password> 
	   </p>
	   <p>
	    确认密码:<s:password name = "qrpassword" label = "确认密码" value = "%{#user.qrpassword}"></s:password>
	   </p>
	   <p>
	    电子邮箱:<s:textfield name = "email" label = "电子邮箱"  value = "%{#user.email}"></s:textfield>
	   </p>
	   <p>
