...
<html>
  ...
  <div id="container" class="clear">
    <!-- ####################################################################################################### -->
    <div id="content">
      <h1><s:property value = "#selectclass.classname"/></h1>
      ...
      <p>教学计划：<s:property value = "#selectclass.classplan"/>。</p>
      <p>使用教材：<s:property value = "#selectclass.classbook"/>。</p>
      <p>考核方式：<s:property value = "#selectclass.classexam"/>。</p>
      ...
      <p><a href = "selectintroduceinformation.action?jid=<s:property value = "#session.intro.getRegistertableByJid().getZcid()"/>" title="教师简历">任课教师</a>:<s:property value = "#session.intro.getRegistertableByJid().getYhm()"/></p>
      <p>性别：<s:property value = "#session.intro.getRegistertableByJid().getSex()"/></p>
      <p>年龄：<s:property value = "#session.intro.getRegistertableByJid().getAge()"/></p>
      <p>学科领域：<s:property value = "#session.intro.getRegistertableByJid().getScience()"/></p>
