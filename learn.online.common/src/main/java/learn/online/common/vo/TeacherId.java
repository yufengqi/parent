...
public class TeacherId implements java.io.Serializable {
	...
	/** minimal constructor */
	public TeacherId(int zcid, String yhm, String registername,
			int cid) {
		this.zcid = zcid;
		this.yhm = yhm;
	...
	/** full constructor */
	public TeacherId(int zcid, String yhm, String registername,
			String sex, int age, String image, int cid,
			String classname, String classtime, String classimage) {
		this.zcid = zcid;
		this.yhm = yhm;
		this.registername = registername;
		this.sex = sex;
	...
	public boolean equals(Object other) {
		...
		return ((this.getZcid() == castOther.getZcid()) || (this.getZcid() != 0
				&& castOther.getZcid() != 0 && this.getZcid()==
				castOther.getZcid()))
				&& ((this.getYhm() == castOther.getYhm()) || (this.getYhm() != null
